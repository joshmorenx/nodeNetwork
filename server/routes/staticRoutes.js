...
// static files
// app.use('/api/public/', express.static(path.join(__dirname, '../public')))  // the ez way

// get static profile user picture
// server\public\uploads\users\joshmorenx\profile\profile.jpg

app.get('/api/public/uploads/users/:username/profile/profile.jpg', /*middleware,*/ (req, res) => { // best way -> in order to set a middleware
