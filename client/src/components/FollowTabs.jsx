    ...
    return (
        <>
            <ul className={'permission-tabs flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400'}>
                <li className="me-2">
                    <a href="#" onClick={() => handledSelectedTab(1)} className={selectedTab == 1 ? selected : unselected}> Seguidores </a>
                </li>
                <li className="me-2">
                    <a href="#" onClick={() => handledSelectedTab(2)} className={selectedTab == 2 ? selected : unselected}> Siguiendo </a>
                </li>
            </ul>
        </>
    )
