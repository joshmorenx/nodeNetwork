...
export default function ImageViewer({ image, setImgClickedPath }){
    ...
    return (
        (img ?
            (<>
            <Box sx={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 100, bgcolor: '#00000099' }} onClick={handleClose} ></Box>
            <Box sx={{ borderRadius: '5px', padding: '2%', bgcolor: '#fadea7', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 101 }}>
